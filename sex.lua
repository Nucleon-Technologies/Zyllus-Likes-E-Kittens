...
Players.PlayerAdded:Connect(function(plr)
    ...
    local VisualsTB = Window:MakeTab({
        Name = "Visuals",
        Icon = "rbxassetid://4483345998",
        PremiumOnly = false
    })
    local ESPSC = VisualsTB:AddSection({
        Name = "Esp"
    })
    ...
    local CustomizeSC = VisualsTB:AddSection({
        Name = "Customize"
    })
    CustomizeSC:AddToggle({
        Name = "Team Colors",
        Default = false,
        Callback = function(val)
            TeamColors = val
...
if lp.Character:FindFirstChild "Head" then
    ...
    local MiscTB = Window:MakeTab({
        Name = "Misc",
        Icon = "rbxassetid://4483345998",

        PremiumOnly = false
    })
    local MiscSC = MiscTB:AddSection({
        Name = "Misc"
    })
    MiscSC:AddParagraph("Credits","                                Scripted by - Zyllus#4719")
    MiscSC:AddButton({
        Name = "Discord Invite",
        Callback = function()
            setclipboard("https://discord.io/Nucleon")
            Notify("Copied To Clipboard!")
          end    
    })
    MiscSC:AddButton({
        ...
        Callback = function()
            setclipboard("https://discord.io/Nucleon")
            Notify("Please wait for a while.. The game file will be in your exploit's 'workspace' Folder.")
          saveinstance()
        end    
    })
    MiscSC:AddButton({
...
ts:Teleport(game.PlaceId, p)
    ...
    MiscSC:AddButton({
        Name = "Draw Functions Python File",
        Callback = function()
            writefile("NucFuncs.py", "You cant see this cause you bad")
            wait(2)
            Notify("Drew file, Check the workspace folder!")
    ...
    local FilesSC = MiscTB:AddSection({
        Name = "Files"
    })
    getgenv().FileName = "nil"
    getgenv().FileText = "nil"
    local ReadField = FilesSC:AddParagraph("Read Field","Nothing is here yet :C")
    FilesSC:AddTextbox({
        Name = "Name Of file",
        Default = "File.txt",
        TextDisappear = true,
        Callback = function(Value)
            getgenv().FileName = Value
        end	  
    })
    FilesSC:AddTextbox({
        Name = "File Text",
        ...
        TextDisappear = true,
        Callback = function(Value)
            getgenv().FileText = Value
        end	  
    })
    FilesSC:AddButton({
        Name = "Create File",
        Callback = function()
            writefile(getgenv().FileName, getgenv().FileText)
          end    
    })
    local ReadFile = 'not'
    FilesSC:AddButton({
        Name = "Read File",
        Callback = function()
            ReadField:Set("Read Field", readfile(getgenv().FileName))
          end    
    })
    local WebSC = MiscTB:AddSection({
        Name = "WebClient"
    })
    local WebField = WebSC:AddParagraph("WebClient","Nothing is here yet :C")
    getgenv().URLbyUser = "string"
    WebSC:AddTextbox({
        Name = "URL",
        Default = "URL",
        TextDisappear = true,
        Callback = function(Value)
            getgenv().URLbyUser = Value
        end	  
    })
    ...
    WebSC:AddButton({
        Name = "Read Raw URL",
        Callback = function()
            WebField:Set("WebClient", game:HttpGet(getgenv().URLbyUser))
          end    
    })
